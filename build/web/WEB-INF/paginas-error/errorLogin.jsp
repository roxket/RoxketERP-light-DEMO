<%-- 
    Document   : errorLogin
    Created on : 17 sept. 2019, 19:23:03
    Author     : Oxker Studio
--%>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="text-center">
					<i class="fal fa-rocket rotate-n-15 fa-3x" style="color: #4e73df;"></i>
					<br>
					<h4 class="m-0 font-weight-bold text-primary">Roxket Lab</h4>
					<br>	
						<div class="alert alert-danger alert-dismissible fade show" role="alert">
							<strong>${pageContext.exception.message}</strong>
                  ...
                  <div class="text-center">
                    <a class="small" href="registrarse.jsp">Crear una cuenta!</a>
                  </div>
                </div>
              </div>
            </div>
