				...
				<div id="content-wrapper" class="d-flex flex-column">
					...
					<jsp:include page="../layouts/header.jsp"></jsp:include>
						...
						<div class="container-fluid">
							...
							<!-- Page Heading -->
							<h1 class="h3 mb-2 text-gray-800"> <%= tipoForm %> categorias</h1>
							<p class="mb-4">Configuración de datos de la categoria.</p>

							<!-- DataTales Example -->
							<div class="card shadow mb-4">
								<div class="card-header py-3">
									<h6 class="m-0 font-weight-bold text-primary">Configuración Categoria</h6>
								</div>
									<form action="categorias" method="post" class="needs-validation" novalidate>
										<div class="form-row pt-3 pr-3 pl-3">
											<div class="form-group col-md-6">
												<input type="hidden" name="accion" value="<%= tipoForm %>">

												<label for="idCat">ID</label>
													<input type="number" class="form-control" name="idCat" id="idCat" placeholder="ID Categoria" value="<% if(tipoForm.equals("Actualizar")){out.print(categoria.getCategoriaId());}%>" required <% if(tipoForm.equals("Actualizar")){out.print("readonly");}%>>
											...
											<div class="form-group col-md-6">
												...
												<input type="text" class="form-control" name="nombreCat" id="nombreCat" placeholder="Nombre categoria" value="<% if(tipoForm.equals("Actualizar")){out.print(categoria.getNombreCat());}%>" required >
												<div class="invalid-feedback">
													Nombre no válido
												</div>
											</div>
